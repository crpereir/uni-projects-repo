...
object App {
    ...
    fun getFirstIDAvailable(): String {
        ...
        return if (id <= TOTAL_USERS) {                      //ADIÇÃO DOS 1000 USERS
            id.toString()
        } else return throw IllegalArgumentException("User must be between 1 and $TOTAL_USERS")
    }
