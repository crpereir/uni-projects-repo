...
class TestStreamMedian {
    ...
    fun testCrescent() {
        ...
        for( i in 1 .. N) {
            s.updateSet(i)
            assertEquals((i + 1)/2, s.getMediana())
        }
    }
    ...
    fun testConsecutivos() {
        ...
        for( i in N downTo 1) {
            s.updateSet(i)
            assertEquals((N+i)/2, s.getMediana())
        }
    }
