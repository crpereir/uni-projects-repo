    ...
    override fun apply(test: Statement, description: Description): Statement =
        object : Statement() {
            override fun evaluate() {
                ...
                val defaultUsersService = testApplication.usersService
                val defaultGamesService = testApplication.gamesService
                val defaultHomeService = testApplication.homeService
                try {
                    ...
                    testApplication.usersService = defaultUsersService
                    testApplication.gamesService = defaultGamesService
                    testApplication.homeService = defaultHomeService
                }
            }
        }
}
